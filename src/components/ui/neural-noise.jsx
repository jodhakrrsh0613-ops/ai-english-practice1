...
export function NeuralNoise({ color = [0.48, 0.22, 0.92], opacity = 0.5, speed = 0.001 }) {
  ...
  function getUniforms(gl, program) {
    const uniforms = {};
    const uniformCount = gl.getProgramParameter(program, i => gl.ACTIVE_UNIFORMS); // Wait, this loop was slightly wrong in original or just weird
